...
//
//    private List<LedgerRecord> ledgerRecords;
...
//        isEdite = false;
//        construirFormulario();
//        ledgerRecords = new ArrayList<>();
//        journalEntry = new JournalEntry();
//    }
//
//    public FormularioPestana(@NotNull JournalEntry journalEntry) {
//        isEdite = true;
//        construirFormulario();
//        this.journalEntry = journalEntry;
//        this.texareConcepto.setText(journalEntry.getConcepto());
//        this.texfieNombre.setText(journalEntry.getNombre());
//        this.texfieNoDoc.setText(DECIMAL_FORMAT.format(journalEntry.getId()));
//        this.texfieNoCheque.setText(journalEntry.getNumeroCheque());
//        this.ledgerRecords = journalEntry.getLedgerRecords();
//        if (tabRegistros.getModel() instanceof DefaultTableModel model) {
//            for (var registro : ledgerRecords) {
//                model.addRow(new Object[]{
//                        registro.getDocumentType().getNombre(), registro.getComprobante(),
//                        registro.getReferencia(), registro.getAccount().getId(),
...
//                ledgerRecords.remove(ledgerRecords.get(filaIndice));
...
//        if (validarDatos()) {
//            journalEntry.setFecha((LocalDate) spiFecha.getValue());
//            journalEntry.setNumeroCheque(texfieNoCheque.getText());
//            journalEntry.setNombre(texfieNombre.getText());
//            journalEntry.setConcepto(texareConcepto.getText());
//            ledgerRecords.forEach(registro -> registro.setJournalEntry(journalEntry));
//            journalEntry.setLedgerRecords(ledgerRecords);
//            AsientoRepo.update(journalEntry);
