...
//        CuentaRepo.getInstance().findAll().forEach(System.out::println);
    }
    ...
    private void initComponents() {
        ...
        jCheckBoxMenuItem4.setText("Excel");
        jMenu4.add(jCheckBoxMenuItem4);

        jCheckBoxMenuItem5.setSelected(true);
        jCheckBoxMenuItem5.setText("Word");
        jMenu4.add(jCheckBoxMenuItem5);

        jCheckBoxMenuItem6.setSelected(true);
        jCheckBoxMenuItem6.setText("PDF");
        ...
        jCheckBoxMenuItem8.setText("Imprimir");
